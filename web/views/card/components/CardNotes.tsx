    ...
    <div className="mt-3 pt-3 border-t border-theme">
      ...
      {isExpanded && (
        <div className="mt-2">
          ...
          <textarea
            className="w-full p-2 rounded border border-theme bg-primary text-primary text-sm resize-none focus:outline-none focus:ring-1 focus:ring-accent"
          ...
          <div className="mt-2 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              {hasExistingNote && (
                <button
                  className={`px-3 py-1 rounded text-xs ${deleteConfirm ? 'bg-red-700' : 'bg-red-500'} text-white hover:opacity-90 disabled:opacity-50 ${bounceButton}`}
              ...
              <button
                className={`px-3 py-1 rounded text-xs bg-accent text-white hover:opacity-90 disabled:opacity-50 ${bounceButton}`}
                onClick={handleSave}
